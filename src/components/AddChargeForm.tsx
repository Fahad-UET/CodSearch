...
import { createMonthlyCharge } from '@/services/firebase';
...
export function AddChargeForm({ categoryId, subcategoryId, onClose }: AddChargeFormProps) {
  ...
  const { addMonthlyCharge } = useProductStore();
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const chargeId = `chargeID-${crypto.randomUUID()}`;
      ...
      await createMonthlyCharge(user.uid, charge)
        .then()
