...
import { X, Store, Star, Truck, Download } from 'lucide-react';
import { OneSevenProduct } from '../../services/oneSeven';

interface OneSevenProductModalProps {
  product: OneSevenProduct;
  onClose: () => void;
  onImport: (product: OneSevenProduct) => void;
}

export function OneSevenProductModal({ product, onClose, onImport }: OneSevenProductModalProps) {
  return (
