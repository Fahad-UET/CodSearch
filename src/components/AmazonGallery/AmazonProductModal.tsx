...
import { X, ShoppingBag, Star, Truck, Store, Download } from 'lucide-react';
import { AmazonProduct } from '../../services/amazon';

interface AmazonProductModalProps {
  product: AmazonProduct;
  onClose: () => void;
  onImport: (product: AmazonProduct) => void;
}

export function AmazonProductModal({ product, onClose, onImport }: AmazonProductModalProps) {
  return (
