...
export function CalculatorDisplay({ value, formula }: CalculatorDisplayProps) {
  return (
    <div className="p-4 md:p-8 bg-gradient-to-br from-white to-purple-50">
      <div className="bg-white/80 backdrop-blur-sm p-6 rounded-xl shadow-inner border border-purple-100">
